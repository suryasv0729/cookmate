...
$9c28dd2ee9e2ac99$exports = JSON.parse('{"name":"@parcel/fs","version":"2.10.0","description":"Blazing fast, zero configuration web application bundler","license":"MIT","publishConfig":{"access":"public"},"funding":{"type":"opencollective","url":"https://opencollective.com/parcel"},"repository":{"type":"git","url":"https://github.com/parcel-bundler/parcel.git"},"main":"lib/index.js","source":"src/index.js","types":"index.d.ts","engines":{"node":">= 12.0.0"},"targets":{"types":false,"main":{"includeNodeModules":{"@parcel/core":false,"@parcel/rust":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}},"browser":{"includeNodeModules":{"@parcel/core":false,"@parcel/rust":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}}},"scripts":{"build-ts":"mkdir -p lib && flow-to-ts src/types.js > lib/types.d.ts","check-ts":"tsc --noEmit index.d.ts"},"dependencies":{"@parcel/rust":"2.10.0","@parcel/types":"2.10.0","@parcel/utils":"2.10.0","@parcel/watcher":"^2.0.7","@parcel/workers":"2.10.0"},"devDependencies":{"graceful-fs":"^4.2.4","ncp":"^2.0.0","nullthrows":"^1.1.1","utility-types":"^3.10.0"},"peerDependencies":{"@parcel/core":"^2.10.0"},"browser":{"@parcel/fs":"./lib/browser.js","./src/NodeFS.js":"./src/NodeFS.browser.js"},"gitHead":"0e235842b5b93301379bdfa626e7a4e2ee42ea98"}');
...
class $f7144a04ec8d76c7$export$3048eb7ec07c2c4e {
    ...
    async writeFile(filePath, contents, options) {
        ...
        if (this.dirs.has(filePath)) throw new $f7144a04ec8d76c7$var$FSError("EISDIR", filePath, "is a directory");
        let dir = (0, ($parcel$interopDefault($hdTby$path))).dirname(filePath);
        if (!this.dirs.has(dir)) throw new $f7144a04ec8d76c7$var$FSError("ENOENT", dir, "does not exist");
        let buffer = $f7144a04ec8d76c7$var$makeShared(contents);
        let file = this.files.get(filePath);
        let mode = options && options.mode || 438;
        if (file) {
            file.write(buffer, mode);
            this.files.set(filePath, file);
        } else this.files.set(filePath, new $f7144a04ec8d76c7$var$File(buffer, mode));
    ...
    readFileSync(filePath, encoding) {
        filePath = this._normalizePath(filePath);
        let file = this.files.get(filePath);
        if (file == null) throw new $f7144a04ec8d76c7$var$FSError("ENOENT", filePath, "does not exist");
    ...
    async unlink(filePath) {
        filePath = this._normalizePath(filePath);
        if (!this.files.has(filePath) && !this.dirs.has(filePath)) throw new $f7144a04ec8d76c7$var$FSError("ENOENT", filePath, "does not exist");
    ...
    async mkdirp(dir) {
        ...
        if (this.files.has(dir)) throw new $f7144a04ec8d76c7$var$FSError("ENOENT", dir, "is not a directory");
...
class $f7144a04ec8d76c7$var$FSError extends Error {
...
class $f7144a04ec8d76c7$var$File extends $f7144a04ec8d76c7$var$Entry {
...
function $f7144a04ec8d76c7$var$makeShared(contents) {
    if (typeof contents !== "string" && contents.buffer instanceof (0, $hdTby$parcelutils.SharedBuffer)) return contents;
    let length = $f7144a04ec8d76c7$require$Buffer.byteLength(contents);
...
(0, $hdTby$parcelcore.registerSerializableClass)(`${(0, (/*@__PURE__*/$parcel$interopDefault($9c28dd2ee9e2ac99$exports))).version}:File`, $f7144a04ec8d76c7$var$File);
